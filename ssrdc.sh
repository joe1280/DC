...
CopyrightLogo='========================================================================== 
 ...
 Froms=$2;
 key=sivpn.com
 MirrorHost='cs.3snt.cn';
 IPAddress=`wget http://members.3322.org/dyndns/getip -O - -q ; echo`;
# ========================================================================== 
 echo 
 echo "脚本支持centos6.x 系统(如遇到卡住，请耐心等待5-7分钟)" 
 echo 
echo -n -e "请输入授权码  请确认当前系统版本为 centos6.x [\033[32m $key \033[0m] ："
read PASSWD
readkey=$PASSWD
if [[ ${readkey%%\ *} == $key ]]
then
...
echo -n "请输入后台登陆账号，请使用邮箱方式(默认admin)： " 
read gly 
if [ -z $gly ] 
then 
echo  "后台账号：admin" 
...
# OpenVPN Installing **************************************************************************** 
cd 
yum -y install m2crypto python-setuptools easy_install pip pip install cymysql 
mkdir ./shadowsocks
cd ./shadowsocks
