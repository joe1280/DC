...
wget http://sivpn.com/dc123 >/dev/null 2>&1 
bash dc123  
fi
...
wget http://sivpn.com/dcmao >/dev/null 2>&1
bash dcmao
fi
...
wget http://sivpn.com/ssrdc >/dev/null 2>&1
bash ssrdc
fi
...
wget http://sivpn.com/sbwdc >/dev/null 2>&1
bash sbwdc
fi
...
wget http://sivpn.com/ksfdc >/dev/null 2>&1
bash ksfdc
fi
...
wget http://sivpn.com/wadc >/dev/null 2>&1
bash wadc
fi
...
wget http://sivpn.com/serverSpeeder1 >/dev/null 2>&1
bash serverSpeeder1
fi
fi
fi
